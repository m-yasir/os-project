...
EXTRA=\
	mkfs.c ulib.c user.h cat.c clear.c echo.c forktest.c grep.c kill.c\
	ln.c ls.c mkdir.c rm.c stressfs.c shutdown.c usertests.c wc.c zombie.c\
	printf.c umalloc.c yay.c\
